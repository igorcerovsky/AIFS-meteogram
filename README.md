...
| `--tz`, `--timezone` | `local` | Time zone mode for X-axis: `local` (Default, location time), `utc`, `winter` (Standard time), `summer` (Daylight Saving Time) |
...
- Select time zone (**Local Time** [default], **UTC**, **Winter Time**, or **Summer Time**)
